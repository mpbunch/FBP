...
output = function(model, df, partition='test', title=FALSE, output=TRUE){
    ...
    if(output){
        ...
        plot(
            ...
            main = ifelse(title, title, paste0('Pred Vs Actual FBP: ', partition,' data ')),
            xlab = "Actual Foreign Born Pct",
            ylab = "Predicted Foreign Born Pct"
        )
...
# pick three cases, and use explainer
    # high - medium - low
    # quantiles, predicted fbp vector, get the row number
